...
import { generateLewissFauxwoodTableEntryListAsync } from "./lewissFauxwoodTableEntry";

export async function createLewissFauxwoodWorksheetAsync(
  blindType: BlindType,
  ...
  const entryList = await generateLewissFauxwoodTableEntryListAsync(
